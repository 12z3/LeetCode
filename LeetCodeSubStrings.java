...
//    private static String palindromsLeetCodeFinal(String s) {
//        StringBuilder stb = new StringBuilder();
//        StringBuilder stbR;
//        StringBuilder stbL;
//        List<StringBuilder> stbAll = new ArrayList<>();
...
//                char y = s.charAt(p);
//
//                if (s.indexOf(y, idxFrom) != -1) {         // За всяка една буква обхожда стринга за съвпадение.
//                    int idx = s.indexOf(y, idxFrom);
//                    stbR = new StringBuilder(s.substring(p, idx + 1));
//                    stbL = new StringBuilder(stbR).reverse();
//                    idxFrom = idx + 1;
